...
class UpdateChecksumBatchSingleWorkflow(AbsWorkflow):
    ...
    def discover_task_metadata(self, initial_results: List[Any],
        ...
        return UpdateChecksumBatchSingle.discover_task_metadata(**user_args)
...
class UpdateChecksumBatchMultipleWorkflow(AbsWorkflow):
    ...
    def discover_task_metadata(self, initial_results: List[Any],
                               additional_data, **user_args) -> List[dict]:
        return UpdateChecksumBatchMultiple.discover_task_metadata(**user_args)

    def user_options(self):
        return UpdateChecksumBatchMultiple.get_user_options()
