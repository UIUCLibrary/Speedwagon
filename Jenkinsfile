                        ...
                        stage("CMake Configure"){
                            steps {
                                ...
                                tee('configure_standalone_cmake.log') {
                                    dir("cmake_build") {
                                        bat "dir"
                                        cmake arguments: "../source -DSPEEDWAGON_PYTHON_DEPENDENCY_CACHE=${TEMP}/Speegwagon/python_deps -DSPEEDWAGON_VENV_PATH=${WORKSPACE}/standalone_venv", installation: "${CMAKE_VERSION}"
