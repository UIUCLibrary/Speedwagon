    ...
    stages {
        ...
        stage("Configure Environment"){
            steps {
                ...
                cache(caches: [[$class: 'ArbitraryFileCache', excludes: '', includes: '**/*', path: 'venv']], maxCacheSize: 300) {
                    ...
                    steps {
                        tee('build_standalone.log') {
                            ...
                            script {
                                ...
                                pipenv run MSBuild ${env.WORKSPACE}\\windows_build\\release.pyproj /nologo /t:msi /p:ProjectRoot=${env.WORKSPACE} /p:PYTHONPATH="${python_path}"
                                """
