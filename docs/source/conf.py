...
def get_project_metadata():
    metadata_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "../..", 'frames', '__version__.py'))
    metadata = dict()
...
latex_documents = [
    (master_doc, 'frames.tex',  '{} Documentation'.format(metadata['__title__']),
...
texinfo_documents = [
    (master_doc, metadata['__title__'], '{} Documentation'.format(metadata['__title__']),
    metadata['__author__'], 'frames', metadata['__description__'],
     'Miscellaneous'),
]
